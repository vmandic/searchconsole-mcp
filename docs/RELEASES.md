...
Agents: follow [.cursor/skills/ship-release/SKILL.md](../.cursor/skills/ship-release/SKILL.md) and [git-commit.mdc](../.cursor/rules/git-commit.mdc) (confirmation gates before npm publish and git tag).
